...
def synthesizer_instructions() -> str:
    return (
        ...
        "- Mark sources as weak when they are undated, anonymous, promotional, advocacy-"
        "driven, user-edited, blog/forum style, or only cite inaccessible primary work.\n"
...
def reporter_instructions() -> str:
    return (
        ...
        "- Judge source quality generically from provenance, not from a hardcoded allow "
        "or deny list. Stronger sources are direct, dated, attributable, primary, "
        "institutional, peer-reviewed, official, or transparent about methods. Weaker "
        "sources are anonymous, undated, promotional, advocacy-driven, user-edited, "
        "blog/forum style, thin summaries, or cite inaccessible work without details.\n"
